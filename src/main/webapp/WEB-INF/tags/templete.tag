    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar" style="min-height: 100%">
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="https://tx.me/riptidexd"> <i class="fa fa-thumbs-o-up"></i>Suggest an Idea</a></li>
                <li><a href="https://tx.me/riptidexd"> <i class="fa fa-bug"></i>Report a bug </a></li>
                <li><a href="mailto:superlosser26@gmail.com"> <i class="fa fa-envelope-o "></i>Contact us</a></li>
            </ul>
        </nav>
